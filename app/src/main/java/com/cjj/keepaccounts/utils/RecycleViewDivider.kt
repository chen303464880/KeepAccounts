...
/**
 * @author chenjunjie
 * Created by CJJ on 2017/11/29 14:17.
 */
class RecycleViewDivider : RecyclerView.ItemDecoration {
    private var mPaint: Paint? = null
    private var mDivider: Drawable? = null
    private var mDividerHeight = 2//分割线高度，默认为1px
    private var mOrientation: Int = LinearLayoutManager.HORIZONTAL//列表的方向：LinearLayoutManager.VERTICAL或LinearLayoutManager.HORIZONTAL
